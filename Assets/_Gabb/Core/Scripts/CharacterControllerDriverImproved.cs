...
namespace Gabb.XR
{
    ...
    /// Provides roomscale collision
    /// </summary>
    [AddComponentMenu("Gabb/Character Controller Driver Improved", 11)]
    public partial class CharacterControllerDriverImproved : MonoBehaviour
    {
        [SerializeField]
